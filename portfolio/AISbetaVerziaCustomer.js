...
function loadJSON(callback) {
    ...
    xobj.open('GET', 'http://127.0.0.1:4000/portfolio/ais_krok.json', false); // Replace 'my_data' with the path to your file
...
if (!document.getElementById(cssTutorial)) {
    ...
    link.rel = 'stylesheet';
    link.type = 'text/css';
    link.href = '/portfolio/cssTutorial.css';
    link.media = 'all';
...
function createNav(text, element) {
    ...
    try {
        ...
        styleText = 'top: ' + (parent_position.top-10 + window.pageYOffset) + 'px; left: ' + (parent_position.left + window.pageXOffset) + 'px;';
        ...
        styleText = 'display: initial; height: 100%;';
...
sidePanelHeadline.textContent = "VITAJTE PREHLIADKE NA STRANKE chrissvk.github.io";
sidePanelPopis.textContent = "Dostupne prehliadky";
